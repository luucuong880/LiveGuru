...
public class BackEnd extends BaseTest {
	...
	@BeforeClass
	public void beforeClass(@Optional("local") String envName, @Optional("testing") String serverName, @Optional("safari") String browserName, @Optional("Mac") String osName, @Optional("10") String osVersion, @Optional("localhost") String ipAddress,
